...
function Header() {
  ...
  return (
    ...
    <Container>
      ...
      <i class="fa-solid fa-truck-fast me-2"></i>EKart</Link></Navbar.Brand>
      <Navbar.Toggle aria-controls="basic-navbar-nav" />
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ms-auto">
          <Nav.Link className='btn border rounded'>
            <Link  to={"/wishlist"} className='d-flex align-items-center' style={{textDecoration:"none",color:"white",fontWeight:"bold"}}><i class="fa-solid fa-heart text-danger me-2"></i>Wishlist
